...
- **Space-state**: Always use "space-state" (the standardized term with single hyphen). Do not use "space-time" or variations like "space--state"
...
- Follow the standardized terminology (see Naming Standards above)
