...
\begin{itemize}
    ...
    \item \texttt{optimization\_algorithm}: Selection of optimization method (\texttt{'gradient\_descent'}, \texttt{'mcmc'}, \texttt{'enkf'}, \texttt{'pso'})
    ...
    \item \texttt{algorithm\_kwargs}: Algorithm-specific parameters (learning rate, ensemble size, etc.)
\end{itemize}
