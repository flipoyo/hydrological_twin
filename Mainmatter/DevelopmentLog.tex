...
If the immediate goal is to verify that the public rendering tier, the private computation tier, and the restricted expert tier defined in Chapter~\ref{chap-arch-decomp} can be enforced reliably, Django is therefore appropriate as a \textbf{control-plane} technology.
