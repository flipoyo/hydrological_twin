...
This separation is enforced at the repository level through Git access policies. The parameter repositories can remain private, while their \texttt{GitSynchroRecord} instances and cryptographic fingerprints are still registered in the space-state and in the universal registry.
