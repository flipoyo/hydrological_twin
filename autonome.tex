...
La synchronisation dans le continuum \textit{space-state} apporte cette mémoire du système. Elle donne au multi-échelle sa colonne vertébrale documentaire et scientifique.
...
\begin{enumerate}
    ...
    \item la gestion des droits, de la propriété intellectuelle et de la certification de l'originalité des jumeaux et de leurs composants, avec suivi de leur évolution dans le continuum \textit{space-state}.
\end{enumerate}
